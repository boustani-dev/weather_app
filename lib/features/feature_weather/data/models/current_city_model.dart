...
///we extend the currentCityModel with CurrentCityEntity, to asynchronously initialize the CurrentCityEntity Class Parameters,
/// so we use the super constructor
class CurrentCityModel extends CurrentCityEntity {
  ...
  factory CurrentCityModel.fromJson(Map<String, dynamic> json) {
    ...
    //معمولا آرایه ها رو اینجوری مقدار دهی میکنیم
    List<Weather> weather = [];
